...
namespace ShopMVC.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(HshopContext context)
        {
            _context = context;
        }
        ...
        {
            var hshopContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await hshopContext.ToListAsync());
        }
